    ...
    <Section className="about-section">
      <div className="about-content">
       <h1 className="about-heading">About me</h1>
        ...
        <div>  <Text size="medium" className="about-text">Hi, I am Sumaiyah. Currently pursuing Full Stack Web Development <br></br>at Red River Polytechnic College.</Text></div><br></br>
